...
export default function CreatePev() {
    const { data, setData, post, processing, errors } = useForm<PevFormData>({
        owner_full_name: '',
        owner_email: '',
        owner_phone: '',
        owner_address: '',
                    ...
                    <div className="mb-8">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">
                                Add your Personal Electric Vehicle to the national registry
                            </p>
                        </div>
                    </div>
                            ...
                            <CardHeader>
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription>
                                            Personal details of the PEV owner
                                        </CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
                            ...
                            <CardHeader>
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription>
                                            Details about the electric vehicle
                                        </CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
